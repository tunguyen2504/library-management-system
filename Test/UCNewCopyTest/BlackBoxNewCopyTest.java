...
public class BlackBoxNewCopyTest {
    ...
    private void setBook_list (){
        ...
        book_lists.add(book);
        book = new BookInfo("NV0167", "To kill a mocking bird", "Harper Lee",
                50000, 3, "9788373015470", "Borrowable", "Grand Central", "Lent");
        book_lists.add(book);
        book = new BookInfo("NV0167", "To kill a mocking bird", "Harper Lee",
	...
	@Test
	void checkQualifiedInformation() {
	...
	@Test
	void checkUnqualifiedSequenceNumber() {
		RegisterNewBookCopyController controller = new RegisterNewBookCopyController();
	    BookInfo book = new BookInfo();
	    book.setBookID("PH1000");
